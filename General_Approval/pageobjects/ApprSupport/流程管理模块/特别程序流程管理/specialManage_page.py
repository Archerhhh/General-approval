...
class SpecialManagePage(BasePage):
    model = "xpath=>//a[@href='/ApprSupport/appr/flow/apprFlow/toSpecialFlowList.do']"
    model_frame = "xpath=>//iframe[@src='/ApprSupport/appr/flow/apprFlow/toSpecialFlowList.do']"
    ...
    #新增页面所有元素
    add_button = "xpath=>//span[contains(text(),'新增特别程序流程')]"
    flow = "id=>flowName"
    unit = "id=>selectUnit"
    ...
    edit_button = "xpath=>//span[contains(text(),'编辑特别程序流程')]"
    ...
    delete_button = "xpath=>//span[contains(text(),'删除特别程序流程')]"

...
class AppManagePage(BasePage):
    model = "xpath=>//a[@href='/ApprSupport/appr/flow/apprFlow/toApprFlowList.do']"
    model_frame = "xpath=>//iframe[@src='/ApprSupport/appr/flow/apprFlow/toApprFlowList.do']"
    ...
    #新增页面所有元素
    add_button = "xpath=>//span[contains(text(),'新增审批流程')]"
    flow = "id=>flowName"
    unit = "id=>selectUnit"
    ...
    edit_button = "xpath=>//span[contains(text(),'编辑审批流程')]"
    clear = "xpath=>//input[@value='清空单位']"
    ...
    delete_button = "xpath=>//span[contains(text(),'删除审批流程')]"

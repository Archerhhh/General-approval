...
class regulatoryManagepage(BasePage):
    model = "xpath=>//a[@href='/ApprSupport/appr/flow/apprFlow/toSuperviseFlowList.do']"
    model_frame = "xpath=>//iframe[@src='/ApprSupport/appr/flow/apprFlow/toSuperviseFlowList.do']"
    ...
    #新增页面所有元素
    add_button = "xpath=>//span[contains(text(),'新增监管流程')]"
    flow = "id=>flowName"
    unit = "id=>selectUnit"
    ...
    edit_button = "xpath=>//span[contains(text(),'编辑监管流程')]"
    ...
    delete_button = "xpath=>//span[contains(text(),'删除监管流程')]"

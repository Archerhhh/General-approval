...
class DelayManagePage(BasePage):
    model = "xpath=>//a[@href='/ApprSupport/appr/flow/apprFlow/toDelayFlowList.do']"
    model_frame = "xpath=>//iframe[@src='/ApprSupport/appr/flow/apprFlow/toDelayFlowList.do']"
    ...
    #新增页面所有元素
    add_button = "xpath=>//span[contains(text(),'新增延期申请流程')]"
    flow = "id=>flowName"
    unit = "id=>selectUnit"
    ...
    edit_button = "xpath=>//span[contains(text(),'编辑延期申请流程')]"
    ...
    delete_button = "xpath=>//span[contains(text(),'删除延期申请流程')]"
